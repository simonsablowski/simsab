				...
				<div id="body">
					...
					<div class="section professional-skills">
						...
						<p>
							...
							<span><?php echo $this->localize('Technical Conception'); ?>,</span>
					...
					<div class="section projects">
						...
						<dl>
							...
							<dd class="description">
								<p>
									<?php echo $this->localize('Web application framework (2011)'); ?>
								</p>
								<p>
